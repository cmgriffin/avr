...
// add a signed int to the transmit buffer, send as a sign character then 5
// decimal-value characters

void m_usb_tx_uint(unsigned int i);
// add an unsigned int to the transmit buffer, send as 5 decimal-value
// characters

void m_usb_tx_long(long i);
// add a signed long to the transmit buffer, send as a sign character then 5
// decimal-value characters

void m_usb_tx_ulong(unsigned long i);
// add an unsigned long to the transmit buffer, send as 5 decimal-value
// characters
